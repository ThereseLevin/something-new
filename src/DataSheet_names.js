...
export default class DataSheet_names extends DataSheetBase {
  ...
  makeDefaultItems() {
    ...
    item['document_key'] = "BJ8ROnesIiKxnX6frYqk";
    item['text'] = "Hatt i fnatt";
    item['name'] = "Apelsin";
    item.key = key++;
    
    item = {};
    this.items.push(item);
    item['document_key'] = "SFUBFGRz5XO0hvCk406d";
    item['name'] = "Simon Sandberg";
    item.key = key++;
    
    item = {};
    this.items.push(item);
    item['document_key'] = "bPD91A8tBsyjwvY30aW9";
    item['text'] = "Hejsan Hoppasn";
    item['name'] = "Therese";
    item.key = key++;
    
    item = {};
    this.items.push(item);
    item['document_key'] = "z1IKrsYDNoncMl4v1bam";
    item['text'] = "katt katt katt";
    item['name'] = "Alexandra";
    item.key = key++;
  }
